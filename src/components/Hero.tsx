      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 md:py-16 relative z-10">
        <div className="text-center max-w-3xl mx-auto space-y-6">
          ...
          <div className="flex justify-center mb-1">
            <div className="p-3 sm:p-4 bg-[#131620] rounded-2xl border border-[#D4AF37]/35 shadow-2xl inline-block transform hover:scale-[1.02] transition-transform">
              <div className="block sm:hidden">
                <TimeveraLogo size="lg" variant="gold" showText={true} showTagline={true} />
              </div>
          ...
          {/* Small Tag */}
          <div className="inline-flex items-center gap-1.5 sm:gap-2 px-2.5 py-1 sm:px-3.5 sm:py-1.5 rounded-full bg-[#131620] border border-[#D4AF37]/30 text-[10px] sm:text-xs font-semibold text-[#E5C07B] tracking-wider uppercase shadow-sm">
            <Sparkles className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-[#D4AF37]" />
            <span>Curated Timepieces & Accessories</span>
          </div>

          {/* Main Headline */}
          <h1 className="font-brand text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-[#F8FAFC] uppercase leading-tight">
          ...
          {/* Subtitle */}
          <p className="text-[#A7AFBF] text-xs sm:text-sm md:text-base max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3.5 pt-2">
            <button
              onClick={onShopClick}
              className="w-full sm:w-auto px-5 py-2.5 sm:px-7 sm:py-3 bg-gradient-to-r from-[#D4AF37] to-[#C59B27] hover:from-[#E5C07B] hover:to-[#D4AF37] text-[#0B0C10] font-bold text-[10px] sm:text-xs tracking-widest uppercase transition-all shadow-lg hover:shadow-xl hover:shadow-[#D4AF37]/20 flex items-center justify-center gap-2 cursor-pointer rounded-xl"
            >
            ...
            <a
              ...
              className="w-full sm:w-auto px-5 py-2.5 sm:px-7 sm:py-3 bg-[#131620] hover:bg-[#1A1E2B] border border-[#252A36] text-[#F8FAFC] font-bold text-[10px] sm:text-xs tracking-wider uppercase transition-colors flex items-center justify-center gap-2 shadow-sm rounded-xl cursor-pointer"
            >
