    ...
    <footer className="bg-[#0B0C10] text-[#A7AFBF] border-t border-[#252A36] transition-colors">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="space-y-4">
          ...
          <p className="font-brand text-[#E5C07B] text-base italic font-semibold">
            "{BUSINESS_INFO.tagline}"
          </p>

          <p className="text-xs text-[#A7AFBF] max-w-sm leading-relaxed">
          ...
          {onOpenInstallApp && (
            <div className="pt-2">
              <button
                ...
                className="inline-flex items-center gap-2 px-4 py-2.5 bg-[#131620] hover:bg-[#1A1E2B] border border-[#252A36] hover:border-[#D4AF37]/50 text-[#F8FAFC] text-xs font-bold uppercase tracking-wider transition-all rounded-lg shadow-md cursor-pointer"
              >
        ...
        <div className="space-y-3">
          <div className="font-brand text-[#F8FAFC] font-bold text-sm uppercase tracking-wider text-[#D4AF37]">
            Portfolios
          </div>
        ...
        <div className="space-y-3">
          <div className="font-brand text-[#F8FAFC] font-bold text-sm uppercase tracking-wider text-[#D4AF37] flex items-center gap-1.5">
      ...
      {/* Bottom Bar */}
      <div className="border-t border-[#252A36] py-6 text-center px-4 space-y-2 bg-[#060709]">
        <div className="flex flex-wrap items-center justify-center gap-4 text-[11px] text-[#A7AFBF] pb-2">
        ...
        <p className="text-xs text-[#A7AFBF]/60 tracking-wider">
