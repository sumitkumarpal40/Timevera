...
export const LegalPagesModal: React.FC<LegalPagesModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-black/85 backdrop-blur-sm flex items-center justify-center p-2 sm:p-4 md:p-6 animate-fadeIn">
      <div className="relative w-full max-w-5xl bg-white dark:bg-[#131313] text-zinc-900 dark:text-zinc-100 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-2xl overflow-hidden my-4 flex flex-col max-h-[92vh]">
        {/* Top Header */}
        <div className="bg-zinc-900 text-white p-4 sm:p-6 border-b border-zinc-800 flex items-center justify-between flex-shrink-0">
          <div>
            <div className="text-xs font-bold text-red-400 tracking-wider uppercase mb-1">
              TIMEVERA • Legal & Policies
            </div>
            <h2 className="font-brand text-xl sm:text-2xl font-bold">
              Customer Policies & Service Terms
            </h2>
          </div>
          <button
            onClick={onClose}
            className="p-2 bg-zinc-800 hover:bg-zinc-700 text-zinc-300 hover:text-white rounded-full transition-colors cursor-pointer"
        ...
        {/* Tab Selection Bar */}
        <div className="bg-zinc-100 dark:bg-[#1a1a1a] border-b border-zinc-200 dark:border-zinc-800 px-3 sm:px-6 py-2.5 flex items-center gap-2 overflow-x-auto no-scrollbar flex-shrink-0">
          {tabs.map((t) => {
            const Icon = t.icon;
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-8 space-y-6 text-sm leading-relaxed text-zinc-700 dark:text-zinc-300">
          {/* ========================================================================= */}
          {/* 1. PRIVACY POLICY                                                         */}
          {/* ========================================================================= */}
          {activeTab === 'privacy-policy' && (
            <div className="space-y-6 animate-fadeIn">
              <div className="border-b border-zinc-200 dark:border-zinc-800 pb-4">
                <h3 className="text-xl sm:text-2xl font-bold font-brand text-zinc-900 dark:text-white">
                  Privacy Policy
                </h3>
              ...
              <div className="p-4 bg-zinc-50 dark:bg-[#181818] border border-zinc-200 dark:border-zinc-800 rounded-xl space-y-2">
                ...
                <ul className="list-disc pl-5 text-xs sm:text-sm space-y-1 text-zinc-600 dark:text-zinc-400">
              ...
              <div className="space-y-2">
                <h4 className="font-bold text-zinc-900 dark:text-white">2. How Your Information Is Used</h4>
              ...
              <div className="space-y-2">
                <h4 className="font-bold text-zinc-900 dark:text-white">3. Data Security & Storage</h4>
                <p className="text-xs sm:text-sm">
              ...
              <div className="space-y-2">
                <h4 className="font-bold text-zinc-900 dark:text-white">4. Third-Party Service Providers</h4>
                <p className="text-xs sm:text-sm">
              ...
              <div className="space-y-2">
                <h4 className="font-bold text-zinc-900 dark:text-white">5. Customer Rights & Account Access</h4>
                <p className="text-xs sm:text-sm">
          ...
          {activeTab === 'terms-conditions' && (
            <div className="space-y-6 animate-fadeIn">
              ...
              <div className="space-y-3">
                <h4 className="font-bold text-zinc-900 dark:text-white">1. Website Usage & Scope</h4>
                <p className="text-xs sm:text-sm">
                ...
                <h4 className="font-bold text-zinc-900 dark:text-white">2. Product Information & Pricing</h4>
                <p className="text-xs sm:text-sm">
                ...
                <h4 className="font-bold text-zinc-900 dark:text-white">3. Orders, Order Acceptance & Availability</h4>
                <p className="text-xs sm:text-sm">
                ...
                <h4 className="font-bold text-zinc-900 dark:text-white">4. Payment Modes (COD & UPI)</h4>
                <p className="text-xs sm:text-sm">
                ...
                <h4 className="font-bold text-zinc-900 dark:text-white">5. Limitation of Liability & Intellectual Property</h4>
                <p className="text-xs sm:text-sm">
          ...
          {activeTab === 'shipping-policy' && (
            <div className="space-y-6 animate-fadeIn">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="p-4 bg-zinc-50 dark:bg-[#181818] border border-zinc-200 dark:border-zinc-800 rounded-xl space-y-1.5">
              ...
              <div className="space-y-3">
                <h4 className="font-bold text-zinc-900 dark:text-white">Estimated Delivery Timelines (By Region)</h4>
                ...
                <div className="p-3 bg-amber-50 dark:bg-amber-950/30 border border-amber-300 dark:border-amber-800/60 rounded-xl text-xs text-amber-800 dark:text-amber-300 flex items-start gap-2">
              ...
              <div className="space-y-2">
                <h4 className="font-bold text-zinc-900 dark:text-white">Incorrect Address & Failed Delivery Attempts</h4>
                <p className="text-xs sm:text-sm">
              ...
              <div className="space-y-2">
                <h4 className="font-bold text-zinc-900 dark:text-white">Damaged Transit Package Reporting</h4>
                <p className="text-xs sm:text-sm">
          ...
          {activeTab === 'refund-policy' && (
            <div className="space-y-6 animate-fadeIn">
              ...
              <div className="space-y-3">
                <h4 className="font-bold text-zinc-900 dark:text-white">1. Return Window & Eligibility</h4>
                <p className="text-xs sm:text-sm">
                ...
                <h4 className="font-bold text-zinc-900 dark:text-white">2. Product Condition & Unboxing Recommendation</h4>
                <p className="text-xs sm:text-sm">
                ...
                <h4 className="font-bold text-zinc-900 dark:text-white">3. Non-Returnable Conditions</h4>
                <ul className="list-disc pl-5 text-xs sm:text-sm space-y-1">
                ...
                <h4 className="font-bold text-zinc-900 dark:text-white">4. Return Process & Inspection</h4>
                <p className="text-xs sm:text-sm">
                ...
                <h4 className="font-bold text-zinc-900 dark:text-white">5. Refund Processing (COD & Online)</h4>
                <ul className="list-disc pl-5 text-xs sm:text-sm space-y-1">
          ...
          {activeTab === 'cancellation-policy' && (
            <div className="space-y-6 animate-fadeIn">
              ...
              <div className="space-y-3">
                <h4 className="font-bold text-zinc-900 dark:text-white">1. Cancellation Before Dispatch</h4>
                <p className="text-xs sm:text-sm">
                ...
                <h4 className="font-bold text-zinc-900 dark:text-white">2. Cancellation After Shipment</h4>
                <p className="text-xs sm:text-sm">
                ...
                <h4 className="font-bold text-zinc-900 dark:text-white">3. Refund for Pre-paid Cancellations</h4>
                <p className="text-xs sm:text-sm">
          ...
          {activeTab === 'contact-support' && (
            <div className="space-y-6 animate-fadeIn">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-5 bg-zinc-50 dark:bg-[#181818] border border-zinc-200 dark:border-zinc-800 rounded-2xl space-y-3">
                  <div className="flex items-center gap-3">
                    <div className="p-2.5 bg-red-600/10 text-red-600 rounded-xl">
                      <ShieldCheck className="w-5 h-5" />
                    </div>
                    <div>
                      <div className="text-xs text-zinc-500 font-semibold uppercase">Helpdesk & Support</div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-xs text-zinc-500 font-semibold uppercase">Official Email</div>
                      <a href={`mailto:${BUSINESS_INFO.email}`} className="text-sm font-bold font-mono text-zinc-900 dark:text-white hover:text-red-600">
                        {BUSINESS_INFO.email}
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    <div className="p-2.5 bg-red-600/10 text-red-600 rounded-xl mt-0.5">
                      <MapPin className="w-5 h-5" />
                    </div>
                    <div>
                      <div className="text-xs text-zinc-500 font-semibold uppercase">Store & Warehouse Address</div>
                ...
                <div className="p-5 bg-gradient-to-br from-red-950/30 to-zinc-900 border border-red-900/40 rounded-2xl space-y-3 flex flex-col justify-between">
                  <div>
                    <span className="text-xs font-bold text-red-400 uppercase tracking-wider">Help & Support Desk</span>
                    <h4 className="font-brand text-lg font-bold text-white mt-1">
                  ...
                  <button
                    ...
                    className="w-full py-3 px-4 bg-red-600 hover:bg-red-700 text-white font-bold text-xs uppercase tracking-wider rounded-xl flex items-center justify-center gap-2 transition-colors shadow-lg cursor-pointer"
                  >
              ...
              <div className="p-4 bg-zinc-100 dark:bg-[#1a1a1a] rounded-xl text-xs text-zinc-500 dark:text-zinc-400 border border-zinc-200 dark:border-zinc-800">
