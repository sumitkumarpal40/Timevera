...
export const ProductFilterDrawer: React.FC<ProductFilterDrawerProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden bg-black/75 backdrop-blur-sm flex justify-end animate-fadeIn">
      <div className="w-full max-w-md bg-white dark:bg-[#121212] border-l border-zinc-200 dark:border-[#2e2e2e] h-full flex flex-col justify-between shadow-2xl text-zinc-900 dark:text-white">
        {/* Drawer Header */}
        <div className="p-5 border-b border-zinc-200 dark:border-[#242424] flex items-center justify-between flex-shrink-0">
          <div className="flex items-center gap-2">
            <div className="p-2 bg-red-600/10 text-red-600 rounded-lg">
              <SlidersHorizontal className="w-5 h-5" />
            </div>
            <div>
              <h3 className="font-brand text-lg font-bold">Filters</h3>
          ...
          <div className="flex items-center gap-2">
            {activeCount > 0 && (
              <button
                ...
                className="text-xs text-red-600 hover:text-red-700 font-bold px-2 py-1 hover:bg-red-50 dark:hover:bg-red-950/30 rounded-lg transition-colors cursor-pointer"
              >
                Reset All
              </button>
            )}
            <button
              onClick={onClose}
              className="p-1.5 text-zinc-400 hover:text-zinc-700 dark:hover:text-white rounded-full hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors cursor-pointer"
            >
              <X className="w-5 h-5" />
            </button>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-6 text-sm">
            ...
            <div className="grid grid-cols-4 gap-2">
              {[
                ...
                <button
                  ...
                  className={`py-2 px-1 text-center rounded-lg text-xs font-bold border transition-all cursor-pointer flex items-center justify-center gap-1 ${
          ...
          <div className="space-y-3 pt-3 border-t border-zinc-200 dark:border-zinc-800">
            <label className="flex items-center justify-between p-3 bg-zinc-50 dark:bg-[#181818] rounded-xl border border-zinc-200 dark:border-zinc-800 cursor-pointer">
        ...
        <div className="p-4 bg-zinc-50 dark:bg-[#161616] border-t border-zinc-200 dark:border-zinc-800 flex items-center gap-3 flex-shrink-0">
          <button
            onClick={onResetFilters}
            className="px-4 py-3 bg-zinc-200 dark:bg-zinc-800 hover:bg-zinc-300 dark:hover:bg-zinc-700 text-zinc-800 dark:text-zinc-200 font-bold text-xs uppercase tracking-wider rounded-xl transition-colors cursor-pointer"
          >
            Clear
          </button>
          ...
          <button
            onClick={onClose}
            className="flex-1 py-3 px-4 bg-gradient-to-r from-red-600 to-rose-600 hover:from-red-700 hover:to-rose-700 text-white font-extrabold text-xs uppercase tracking-wider rounded-xl shadow-lg shadow-red-600/30 flex items-center justify-center gap-2 cursor-pointer"
          >
